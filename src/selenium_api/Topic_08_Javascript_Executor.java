...
public class Topic_08_Javascript_Executor {
	...
	public void TC_01_JavascriptExcecutor() {
		...
		// 5 - Add sản phẩm SAMSUNG GALAXY vào Cart (click vào ADD TO CART button bằng JE)
		// 6 - Verify message được hiển thị:  Samsung Galaxy was added to your shopping cart. (Sử dụng JE - Get innertext of the entire webpage )
		// 7 - Open PRIVACY POLICY page (Sử dụng JE). Verify title của page = Privacy Policy (Sử dụng JE)
		// 8 - Srcoll xuống cuối page
		// 9 - Verify dữ liệu có hiển thị với chỉ 1 xpath 
		// 10 - Navigate tới domain: http://demo.guru99.com/v4/  (Sử dụng JE). Verify domain sau khi navigate = http://demo.guru99.com/v4/ 
...
//	@Test
	public void TC_02_RemoveAttribute() {
		...
		// 1 - Truy cập vào trang: https://www.w3schools.com/tags/tryit.asp?filename=tryhtml_input_disabled
		...
		// 5 - Verify dữ liệu sau khi submit chứa đoạn text đã fill trong field Lastname (Automation Testing)
